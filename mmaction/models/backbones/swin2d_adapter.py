...
class Attention(nn.Module):
    def __init__(self, dim, num_ttokens, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., with_qkv=True):
        super().__init__()
    ...
    def forward(self, x):
        ...
        relative_pos_bias = self.relative_position_bias_table[self.relative_coords].view(self.num_ttokens, self.num_ttokens, -1).permute(2, 0, 1).contiguous()
